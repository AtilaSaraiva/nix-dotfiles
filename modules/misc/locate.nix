...
{
  imports = [
    (mkRenamedOptionModule [ "services" "plocate" "period" ] [ "services" "locate" "interval" ])
    (mkRemovedOptionModule [ "services" "plocate" "includeStore" ] "Use services.locate.prunePaths")
  ];

  options.services.plocate = with types; {
    enable = mkOption {
      type = bool;
      default = false;
      description = ''
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.update-plocatedb = {
