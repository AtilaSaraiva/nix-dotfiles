...
in mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://github.com/Ponywka/MultiMC5-with-offline/archive/refs/tags/0.6.12.tar.gz";
    sha256 = "8b491d4f4ca07ca21c6585fabdadbb9a144aafc901e2de90bb561ff56cc9d91d";
  };
